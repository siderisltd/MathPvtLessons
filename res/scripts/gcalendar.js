...
function getAvailableTimeArr(auth, pickedDate) {
    ...
    var firstDay = moment.tz(new Date(pickedDate).addDays(1), "UTC").format();
    var lastDay = moment.tz(new Date(new Date(pickedDate).addDays(7).setHours(23, 59, 00)), "UTC").format();
